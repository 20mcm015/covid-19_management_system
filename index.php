...
<head>
  ...
  <title>Covid-19 Report System</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Covid19-Report System</a>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; KARTHIK 2020</p>
    </div>
    <!-- /.container -->
  </footer>
